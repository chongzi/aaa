    ...
    <div class="box-body">
        <table class="table table-hover table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo url('admin/AuthManager/action', ['id'=>$group['id']]); ?>" class="label label-success">访问授权</a>
                    <a href="<?php echo url('admin/AuthManager/user', ['id'=>$group['id']]); ?>" class="label label-success">成员授权</a>
                </td>
                <td>
                    <?php if($group['status'] == '-1'): ?> <?php echo $group->statusText(); endif; if($group['status'] == '1'): ?>
                    <a href="<?php echo url('admin/group/forbid', ['id'=>$group['id']]); ?>" class="label label-success confirm get"><?php echo $group->statusText(); ?></a>
                    <?php endif; if($group['status'] == '0'): ?>
                    <a href="<?php echo url('admin/group/allow', ['id'=>$group['id']]); ?>" class="label label-danger ajax-get"><?php echo $group->statusText(); ?></a>
                    <?php endif; ?>
                </td>
                <td>
                    <a href="<?php echo url('admin/group/edit', ['id'=>$group['id']]); ?>" class="label label-success">编辑</a>
                    <a href="<?php echo url('admin/group/delete', ['id'=>$group['id']]); ?>" class="label label-danger confirm delete">删除</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
