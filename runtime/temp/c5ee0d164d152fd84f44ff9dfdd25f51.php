		...
		<form method="POST" id="form_list" name="form_list">
			<div class="box box-success">
			    <div class="box-header">
			        <a href="<?php echo url('admin/group/create'); ?>" type="button" class="btn btn-success btn-sm">添加<i class="fa fa-fw fa-plus"></i></a>
			    </div>
			    <div class="box-body">
			        <table class="table table-hover table-bordered">
			            ...
			            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				            <tr>
				                <td>
				                    <input class="check-all" type="checkbox" onclick="chk_child(this)" value="<?php echo $vo['table_name']; ?>" name="table_name[]" />
				                </td>
				                <td><?php echo $vo['table_name']; ?></td>
				                <td>
				                    <?php if($vo['view_status']): ?>
				                        <!-- <input class="check-all" type="checkbox" value="<?php echo $vo['table_name']; ?>" name="table_name[]" checked/> -->
				                        <a>已生成<a>
				                    <?php else: ?>
				                        <input class="check-all <?php echo $vo['table_name']; ?>" type="checkbox" value="<?php echo $vo['table_name']; ?>|view" name="type_name[]" /><a style="color:red;">未生成<a>
				                    <?php endif; ?>
				                </td>
				                <td>
				                    <?php if($vo['controller_status']): ?>
				                        <!-- <input class="check-all" type="checkbox" value="<?php echo $vo['table_name']; ?>" name="table_name[]" checked/> -->
				                        <a>已生成<a>
				                    <?php else: ?>
				                        <input class="check-all <?php echo $vo['table_name']; ?>" type="checkbox" value="<?php echo $vo['table_name']; ?>|controller" name="type_name[]" /><a style="color:red;">未生成<a>
				                    <?php endif; ?>
				                </td>
				                <td>
				                    <?php if($vo['service_status']): ?>
				                        <!-- <input class="check-all" type="checkbox" value="<?php echo $vo['table_name']; ?>" name="table_name[]" checked/> -->
				                        <a>已生成<a>
				                    <?php else: ?>
				                        <input class="check-all <?php echo $vo['table_name']; ?>" type="checkbox" value="<?php echo $vo['table_name']; ?>|service" name="type_name[]" /><a style="color:red;">未生成<a>
				                    <?php endif; ?>
				                </td>
				                <td>
				                    <?php if($vo['logic_status']): ?>
				                        <!-- <input class="check-all" type="checkbox" value="<?php echo $vo['table_name']; ?>" name="table_name[]" checked/> -->
				                        <a>已生成<a>
				                    <?php else: ?>
				                        <input class="check-all <?php echo $vo['table_name']; ?>" type="checkbox" value="<?php echo $vo['table_name']; ?>|logic" name="type_name[]" /><a style="color:red;">未生成<a>
				                    <?php endif; ?>
				                </td>
				                <td>
				                    <?php if($vo['model_status']): ?>
				                        <!-- <input class="check-all" type="checkbox" value="<?php echo $vo['table_name']; ?>" name="table_name[]" checked/> -->
				                        <a>已生成<a>
				                    <?php else: ?>
				                        <input class="check-all <?php echo $vo['table_name']; ?>" type="checkbox" value="<?php echo $vo['table_name']; ?>|model" name="type_name[]" /><a style="color:red;">未生成<a>
				                    <?php endif; ?>
				                </td>
				                <td>
				                    <?php if($vo['validate_status']): ?>
				                        <!-- <input class="check-all" type="checkbox" value="<?php echo $vo['table_name']; ?>" name="table_name[]" checked/> -->
				                        <a>已生成<a>
				                    <?php else: ?>
				                        <input class="check-all <?php echo $vo['table_name']; ?>" type="checkbox" value="<?php echo $vo['table_name']; ?>|validate" name="type_name[]" /><a style="color:red;">未生成<a>
				                    <?php endif; ?>
				                </td>
				            </tr>
			        	<?php endforeach; endif; else: echo "" ;endif; ?>
			    ...
			    <div class="box-header">
			        <a type="button" class="btn btn-success btn-sm" onclick="form_submit('form_list','<?php echo url('module/creates'); ?>','您确定生成吗？')" >生成</a>
			    </div>
			</div>
		</form>
	</div>
